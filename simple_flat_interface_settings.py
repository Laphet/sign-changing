...
if __name__ == "__main__pre_dat__":
    from cem_gmsfem import CemGmsfem, print_log
...
if __name__ == "__main__":
    ...
    delta_u_osly0 = np.load(
        "{0:s}/{1:s}".format(DAT_ROOT_PATH, "delta-u-osly{0:d}-1d01+1d0.npy".format(0))
    )
    delta_u_osly3 = np.load(
        "{0:s}/{1:s}".format(DAT_ROOT_PATH, "delta-u-osly{0:d}-1d01+1d0.npy".format(3))
    )
